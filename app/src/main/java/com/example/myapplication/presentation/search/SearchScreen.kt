...
fun SearchScreen(
    ...
    testInlineFunction({ println("Test")})
    Column(
        modifier = Modifier
...
/*
fun testInlineFunction(fn:() -> Unit){
    fn()
}*/
inline fun testInlineFunction(fn:() -> Unit){
    fn()
}

fun testExtentionFunction(){
println("test ".myExtentionFunction())
}
 fun String.myExtentionFunction():String{
    return "---------/n/n------"
}
